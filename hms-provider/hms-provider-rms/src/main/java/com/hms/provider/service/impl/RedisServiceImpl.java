...
//        rt.expire(key, GlobalConstant.Sys.REDIS_DEFAULT_EXPIRE, TimeUnit.MINUTES);
    ...
    @Override
    public void putHashKey(String key,Object hashkey,Object value){

        Preconditions.checkArgument(StringUtils.isNotEmpty(key), "Redis key is not null");

        HashOperations<String,Object, Object> hps = rt.opsForHash();
        hps.put(key,hashkey,value);
    }
